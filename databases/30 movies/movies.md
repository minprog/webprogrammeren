...
* Start Git Bash (Windows) or open the Terminal application (macOS).
* Execute `cd` to ensure that you're in `~/` (i.e., your home directory, aka `~`).
* Execute `curl -OL https://github.com/minprog/webprogrammeren/raw/2020/Problems/0%20Movies/movies.zip` to download a (compressed) ZIP file with this problem's distribution.
...
While an automatic check is available for this problem, you're encouraged to instead test your code on your own for each of the following. You can run `sqlite3 movies.db` to run additional queries on the database to ensure that your result is correct.
